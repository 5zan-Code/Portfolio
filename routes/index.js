...
router.get ('/', function(req,res,next) {
  res.render('index',{title:'Faizan Ansari',serv1:'My approach to website design is to create a website that strengthens your company’s brand while ensuring ease of use and simplicity for your audience.',
